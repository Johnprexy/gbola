  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-[#050e1d] via-[#0a1628] to-[#0f2040] pt-40 pb-24 overflow-hidden">
        ...
        />
        {/* Red glow for YouTube section */}
        <div className="absolute right-0 top-0 bottom-0 w-1/2 bg-[radial-gradient(ellipse_at_80%_50%,rgba(255,0,0,0.04)_0%,transparent_70%)]" />
        ...
        <div className="max-w-6xl mx-auto px-8 lg:px-12 relative z-10">
          ...
          >
            <p className="text-white/52 text-base max-w-xl leading-[1.75]">
              Watch Rev. Adegbola Oladosu minister the Word on prayer, the Holy Spirit,
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white/40 hover:text-[#c9a84c] text-[11px] transition-colors duration-300"
                >
            ...
            <div className="space-y-2">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={`text-xs font-medium leading-snug line-clamp-2 ${
                      video.id === featuredId ? 'text-[#e8c97a]' : 'text-white/70 group-hover:text-white'
                    }`}>
                      {video.title}
                    </p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full mt-4 py-3 border border-red-600/50 text-red-500 hover:bg-red-600 hover:text-white text-[10px] tracking-[0.2em] uppercase font-semibold transition-all duration-300"
              >
                <Youtube size={13} />
                View Full Channel
              </a>
      ...
      <section className="bg-[#0a1628] py-20">
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          ...
          <div className="text-center mt-12">
            <p className="text-white/35 text-sm mb-5">More videos on Rev. Gbola's YouTube channel</p>
            <a
              href={YOUTUBE_CHANNEL_URL}
              target="_blank"
              rel="noopener noreferrer"
